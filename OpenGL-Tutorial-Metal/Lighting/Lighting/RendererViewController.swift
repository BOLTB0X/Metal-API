...
class RendererViewController: UIViewController {
    ...
    private func setupVertices() {
        let cubeVertices: [Vertex] = [
            // Front
            Vertex(position: simd_float3(-0.5, -0.5, -0.5), toyColor: simd_float3(1.0, 0.5, 0.31)),
            Vertex(position: simd_float3(0.5, -0.5, -0.5), toyColor: simd_float3(1.0, 0.5, 0.31)),
            Vertex(position: simd_float3(0.5, 0.5, -0.5), toyColor: simd_float3(1.0, 0.5, 0.31)),
            Vertex(position: simd_float3(-0.5, 0.5, -0.5), toyColor: simd_float3(1.0, 0.5, 0.31)),
...
//        let cubeVertices: [Vertex] = [
//            // Front
//            Vertex(position: simd_float3(-0.5, -0.5, -0.5), lightColor: simd_float3(0.33, 0.42, 0.18), toyColor: simd_float3(1.0, 0.5, 0.31)),
//            Vertex(position: simd_float3(0.5, -0.5, -0.5), lightColor: simd_float3(0.33, 0.42, 0.18), toyColor: simd_float3(1.0, 0.5, 0.31)),
//            Vertex(position: simd_float3(0.5, 0.5, -0.5), lightColor: simd_float3(0.33, 0.42, 0.18), toyColor: simd_float3(1.0, 0.5, 0.31)),
//            Vertex(position: simd_float3(-0.5, 0.5, -0.5), lightColor: simd_float3(0.33, 0.42, 0.18), toyColor: simd_float3(1.0, 0.5, 0.31)),
//
...
//        ]
    ...
    private func render() {
        ...
        for i in cubePositions.indices {
            ...
            renderEncoder.setFragmentBytes(&lightColors[i], length: MemoryLayout<simd_float3>.size, index: 1)
