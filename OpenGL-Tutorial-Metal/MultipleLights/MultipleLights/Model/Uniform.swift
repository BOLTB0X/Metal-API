...
struct DirLight {
    ...
    init(direction: simd_float3, ambient: simd_float3,
...
// MARK: - PointLights
struct PointLights {
    var pointLightArr: (PointLight, PointLight, PointLight, PointLight)
    
    init(pointLightArr: (PointLight, PointLight, PointLight, PointLight)) {
        self.pointLightArr = pointLightArr
    } // init
